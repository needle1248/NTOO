...
// Usually this is the same physical point where the camera is installed.
const uint16_t POINT_ID = 1;
const uint32_t FRAME_INTERVAL_MS = 2500;

const bool ENROLL_MODE = true;
const char *ENROLL_USER_ID = "blind_user_01";
const bool ENROLL_RETRAIN_AFTER_EACH_FRAME = false;
const uint16_t ENROLL_CAPTURE_LIMIT = 15;
...
const framesize_t CAMERA_FALLBACK_FRAME_SIZE = FRAMESIZE_QVGA;
const int CAMERA_FALLBACK_JPEG_QUALITY = 14;

const bool CAMERA_USE_FLASH = true;
const int CAMERA_FLASH_LED_PIN = 4;
const uint16_t CAMERA_FLASH_PRELIGHT_MS = 150;
